// Package passwordgenerator provides a Go client for the Password Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/passwordgenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Password Generator API.
//
// Parameters:
//   - count (required): integer - The number of passwords to generate [min: 1, max: 100]
//   - length (required): integer - The length of the password to generate [min: 4, max: 128]
//   - complexity (required): string - The complexity of the password
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"count": {Type: "integer", Required: true, Min: float64Ptr(1), Max: float64Ptr(100)},
		"length": {Type: "integer", Required: true, Min: float64Ptr(4), Max: float64Ptr(128)},
...
// ResponseData contains the data returned by the Password Generator API.
