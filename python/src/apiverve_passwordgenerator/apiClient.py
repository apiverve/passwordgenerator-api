...
class PasswordgeneratorAPIClient:
    ...
    VALIDATION_RULES = {
        "count": {"type": "integer", "required": True, "min": 1, "max": 100, "default": 1},
        "length": {"type": "integer", "required": True, "min": 4, "max": 128, "default": 12},
        "complexity": {"type": "string", "required": True, "default": "medium"}
    }
