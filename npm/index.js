...
class passwordgeneratorWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/passwordgenerator');
        }
        ...
        this.validationRules = {"count":{"type":"integer","required":true,"min":1,"max":100,"default":1},"length":{"type":"integer","required":true,"min":4,"max":128,"default":12},"complexity":{"type":"string","required":true,"default":"medium"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/passwordgenerator`);
        }
    }
...
module.exports = passwordgeneratorWrapper;
